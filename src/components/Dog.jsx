...
const Dog = () => {
  ...
  function onBeforeCompile(shader) {
    ...
    shader.fragmentShader = shader.fragmentShader.replace(
      ...
      `
          ...
          float progress = smoothstep(uProgress - transitionFactor,uProgress, (vViewPosition.x+vViewPosition.y)*0.5);
  ...
  dogMaterail.onBeforeCompile = onBeforeCompile;
  ...
  useEffect(() => {
    ...
    document
      .querySelector(`.title[img-title="wallonia"]`)
      .addEventListener("mouseenter", () => {
        material.current.uMatcap1.value = mat18;
        gsap.to(material.current.uProgress, {
          value: -0.8,
